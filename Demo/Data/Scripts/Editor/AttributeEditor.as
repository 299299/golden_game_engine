...
void InitResourcePicker()
{
    ...
    resourcePickers.Push(ResourcePicker("HavokRig", "*.hkx"));
    resourcePickers.Push(ResourcePicker("HavokAnimation", "*.hkx"));
    resourcePickers.Push(ResourcePicker("AnimStateMachine", "*.json"));
