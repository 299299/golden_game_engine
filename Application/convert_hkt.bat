gameDebug.exe --action HavokConvert -f havok/cube.hkt -o core/actor -m model --slient
gameDebug.exe --action HavokConvert -f havok/batman.hkt -o core/character -m skin --slient
